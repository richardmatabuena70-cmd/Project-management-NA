...
function viewApplicant(idValue) {
    ...
    const filesSection = [
        ...
        a.resume ?
            ...
            `<p><b>Resume:</b> <a href="${a.resume}" target="_blank" rel="noopener">📄 View Resume</a></p>` :

            "",

        a.validId ?

            `<p><b>Valid ID:</b> <a href="${a.validId}" target="_blank" rel="noopener">🪪 View ID</a></p>` :
    ...
    openModal(
        ...
        ${filesSection ? `<div style="margin-top:12px; padding-top:12px; border-top:1px solid var(--border);"><b>Uploaded Documents</b><br><br>${filesSection}</div>` : ""}
